...
<svelte:head>
	...
	{/if}
	<meta name="Description" content={json.description || 'Rupi Personal Site'} />
	<meta property="og:description" content={json.description || 'Rupi Personal Site'} />
...
<article use:toc={{ store: tocStore, anchor: false, observe: true, selector: ':where(h1, h2, h3)' }} class="items-start justify-center w-full mx-auto mt-16 mb-32 prose swyxcontent dark:prose-invert max-w-none">
	...
	>
		<p class="flex items-center text-sm text-gray-700 dark:text-gray-300">Rupi</p>
