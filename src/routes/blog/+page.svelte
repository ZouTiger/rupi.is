			...
			{#each POST_CATEGORIES as availableCategory}
				<div>
					...
					<label
						...
						class="inline-flex items-center justify-between w-full px-4 py-2 text-gray-500 bg-white border border-gray-200 cursor-pointer hover:bg-gray-100 hover:text-gray-600 peer-checked:border-purple-600 peer-checked:text-purple-600 peer-checked:bg-purple-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-purple-500 dark:peer-checked:bg-gray-700"
					>
						{availableCategory}
					</label>
				</div>
