...
<section class="flex flex-col items-start justify-center max-w-2xl px-4 mx-auto mb-16 sm:px-8">
			...
			{#each POST_CATEGORIES as availableCategory}
				<div>
					...
					<label
						...
						class="inline-flex items-center justify-between w-full px-4 py-2 text-gray-500 bg-white border border-gray-200 cursor-pointer hover:bg-gray-100 hover:text-gray-600 peer-checked:border-blue-600 peer-checked:text-blue-600 peer-checked:bg-blue-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-gray-200 dark:peer-checked:bg-gray-700 dark:peer-checked:border-gray-400"
					>
						{availableCategory}
					</label>
				</div>
	...
	{#if !search}
		...
		<IndexCard href="/welcome" title="Welcome to swyxkit!" category="essay" stringData="123,456 views">
